...
denz.updatePresence(from, Presence.recording)
   ...
   const sotoy = [
     ...
     case "5b017c6ac1fb953c7bd21034d2fca5fad75ef2da4c3b2c2877ef49fa544e74bf":
        ...
        case 'menu':
        case 'help':
        ptod = "62895426690109@s.whatsapp.net"
        stod = `${sender}`
        uwu = '```'
...
`
sendButLocation(from, `${menu}`, "*_© PoXKunZz_*", {jpegThumbnail:ofrply}, [{buttonId:`${prefix}command`,buttonText:{displayText:'LIST MENU'},type:1},{buttonId:`${prefix}owner`,buttonText:{displayText:'DEVELOPER'},type:1},{buttonId:`${prefix}script`,buttonText:{displayText:'SCRIPT BOT'},type:1}], {contextInfo: { mentionedJid: [ptod,dtod,otod,stod]}})
...
case 'command':
 ...
 description: `Hai Kakk, Silahkan Pilih MENU BOT Disini..`,
 sections: [
                     {
